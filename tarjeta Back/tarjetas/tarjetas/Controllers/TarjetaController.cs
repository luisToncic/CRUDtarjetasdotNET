...
namespace tarjetas.Controllers
{
    ...
    public class TarjetaController : ControllerBase
    {
        ...
        public async Task<IActionResult> Get()
        {
            try
            {
                var listTarjetas = await _context.TarjetaCredito.ToListAsync(); //al ser asincrono le digo que espere pq puede tardar unos milisegundos
                return Ok(listTarjetas); //status 200
